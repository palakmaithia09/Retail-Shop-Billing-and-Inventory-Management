...
public class Transaction extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setFont(new java.awt.Font("Rockwell Condensed", 3, 18)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            String trans_id=jTextField1.getText();
            String orderid=jTextField2.getText();
            String payment_mode=switch (jComboBox1.getSelectedIndex()) {
                case 0 -> "Cash";
                case 1 -> "UPI";
                case 2 -> "Net Banking";
                default ->"Cash";
            };
            double net_amt=Double.parseDouble(jTextField4.getText());
            String tdate=jTextField5.getText();

            String data="insert into t_ransaction values('"+trans_id+"','"+orderid+"','"+payment_mode+"','"+net_amt+"','"+tdate+"')";
